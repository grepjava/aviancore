...
int av_crypto_available(void) { return 0; }
int av_hash_len(int alg) { (void)alg; return -1; }
int av_hash(int a, const void *d, size_t n, unsigned char *o) {
    (void)a; (void)d; (void)n; (void)o; return -1;
}
av_hash_ctx *av_hash_new(int alg) { (void)alg; return NULL; }
void av_hash_update(av_hash_ctx *c, const void *d, size_t n) { (void)c; (void)d; (void)n; }
int av_hash_snapshot(av_hash_ctx *c, unsigned char *o) { (void)c; (void)o; return -1; }
void av_hash_free(av_hash_ctx *c) { (void)c; }
int av_hmac(int a, const void *k, size_t kl, const void *d, size_t dl, unsigned char *o) {
    (void)a; (void)k; (void)kl; (void)d; (void)dl; (void)o; return -1;
}
int av_pbkdf2(int a, const void *p, size_t pl, const void *s, size_t sl, unsigned i,
              unsigned char *o, size_t ol) {
    (void)a; (void)p; (void)pl; (void)s; (void)sl; (void)i; (void)o; (void)ol; return -1;
}
int av_hkdf_extract(int a, const void *s, size_t sl, const void *i, size_t il, unsigned char *o) {
    (void)a; (void)s; (void)sl; (void)i; (void)il; (void)o; return -1;
}
int av_hkdf_expand(int a, const void *p, size_t pl, const void *i, size_t il,
                   unsigned char *o, size_t ol) {
    (void)a; (void)p; (void)pl; (void)i; (void)il; (void)o; (void)ol; return -1;
}
int av_aead_key_len(int alg) { (void)alg; return -1; }
av_aead *av_aead_new(int alg, const unsigned char *key) { (void)alg; (void)key; return NULL; }
void av_aead_free(av_aead *a) { (void)a; }
long av_aead_seal(av_aead *a, const unsigned char n[12], const void *ad, size_t adl,
                  const void *p, size_t pl, unsigned char *o) {
    (void)a; (void)n; (void)ad; (void)adl; (void)p; (void)pl; (void)o; return -1;
}
long av_aead_open(av_aead *a, const unsigned char n[12], const void *ad, size_t adl,
                  const void *c, size_t cl, unsigned char *o) {
    (void)a; (void)n; (void)ad; (void)adl; (void)c; (void)cl; (void)o; return -1;
}
av_hp *av_hp_new(int alg, const unsigned char *key) { (void)alg; (void)key; return NULL; }
void av_hp_free(av_hp *h) { (void)h; }
int av_hp_mask(av_hp *h, const unsigned char s[16], unsigned char m[5]) {
    (void)h; (void)s; (void)m; return -1;
}
av_kex *av_kex_new(int group) { (void)group; return NULL; }
void av_kex_free(av_kex *k) { (void)k; }
long av_kex_public(av_kex *k, unsigned char *o, size_t ol) { (void)k; (void)o; (void)ol; return -1; }
long av_kex_derive(av_kex *k, const unsigned char *p, size_t pl,
                   unsigned char *o, size_t ol) {
    (void)k; (void)p; (void)pl; (void)o; (void)ol; return -1;
}
av_certkey *av_certkey_load(const char *c, const char *k, char *err, size_t el) {
    (void)c; (void)k;
    if (err && el) snprintf(err, el, "this binary was built without OpenSSL");
    return NULL;
}
void av_certkey_free(av_certkey *ck) { (void)ck; }
int av_certkey_chain_count(av_certkey *ck) { (void)ck; return 0; }
long av_certkey_cert_der(av_certkey *ck, int i, unsigned char *o, size_t ol) {
    (void)ck; (void)i; (void)o; (void)ol; return -1;
}
int av_certkey_schemes(av_certkey *ck, uint16_t *o, int m) {
    (void)ck; (void)o; (void)m; return 0;
}
long av_certkey_sign(av_certkey *ck, uint16_t s, const void *m, size_t ml,
                     unsigned char *o, size_t ol) {
...
int av_crypto_available(void) { return 1; }
...
static const EVP_MD *md_for(int alg) {
    switch (alg) {
    case AV_SHA256: return EVP_sha256();
    case AV_SHA384: return EVP_sha384();
    default: return NULL;
    }
}

int av_hash_len(int alg) {
    switch (alg) {
    case AV_SHA256: return 32;
    case AV_SHA384: return 48;
    default: return -1;
    }
}

int av_hash(int alg, const void *data, size_t n, unsigned char *out) {
...
av_hash_ctx *av_hash_new(int alg) {
    const EVP_MD *md = md_for(alg);
    if (!md) return NULL;
    av_hash_ctx *h = calloc(1, sizeof(*h));
    if (!h) return NULL;
    h->md = md;
...
void av_hash_update(av_hash_ctx *h, const void *data, size_t n) {
    if (!h || n == 0) return;
...
int av_hash_snapshot(av_hash_ctx *h, unsigned char *out) {
    if (!h) return -1;
...
void av_hash_free(av_hash_ctx *h) {
    if (!h) return;
...
int av_hmac(int alg, const void *key, size_t key_len,
...
int av_pbkdf2(int alg, const void *password, size_t password_len,
...
int av_hkdf_extract(int alg, const void *salt, size_t salt_len,
                    const void *ikm, size_t ikm_len, unsigned char *out) {
    int n = av_hash_len(alg);
    if (n < 0) return -1;
    ...
    return av_hmac(alg, salt, salt_len, ikm, ikm_len, out) == n ? n : -1;
}

int av_hkdf_expand(int alg, const void *prk, size_t prk_len,
                   const void *info, size_t info_len,
                   unsigned char *out, size_t out_len) {
    int hl = av_hash_len(alg);
    if (hl < 0) return -1;
    ...
    while (done < out_len) {
        ...
        round[n++] = counter;
        if (av_hmac(alg, prk, prk_len, round, n, block) != hl) return -1;
        block_len = (size_t)hl;
...
static const EVP_CIPHER *aead_cipher(int alg) {
    switch (alg) {
    case AV_AEAD_AES128GCM: return EVP_aes_128_gcm();
    case AV_AEAD_AES256GCM: return EVP_aes_256_gcm();
    case AV_AEAD_CHACHA20POLY1305: return EVP_chacha20_poly1305();
    default: return NULL;
    }
}

int av_aead_key_len(int alg) {
    switch (alg) {
    case AV_AEAD_AES128GCM: return 16;
    case AV_AEAD_AES256GCM: return 32;
    case AV_AEAD_CHACHA20POLY1305: return 32;
    default: return -1;
    }
}
...
av_aead *av_aead_new(int alg, const unsigned char *key) {
    const EVP_CIPHER *c = aead_cipher(alg);
    if (!c) return NULL;
    av_aead *a = calloc(1, sizeof(*a));
    if (!a) return NULL;
...
long av_aead_seal(av_aead *a, const unsigned char nonce[12],
...
long av_aead_open(av_aead *a, const unsigned char nonce[12],
                  const void *aad, size_t aad_len,
...
av_hp *av_hp_new(int alg, const unsigned char *key) {
    av_hp *h = calloc(1, sizeof(*h));
    if (!h) return NULL;
...
void av_hp_free(av_hp *h) {
    if (!h) return;
    EVP_CIPHER_CTX_free(h->ctx);
    free(h);
}

int av_hp_mask(av_hp *h, const unsigned char sample[16], unsigned char mask[5]) {
    if (!h) return -1;
    int len = 0;
    if (h->chacha) {
...
av_kex *av_kex_new(int group) {
    int nid;
    switch (group) {
    case AV_KEX_X25519: nid = EVP_PKEY_X25519; break;
    case AV_KEX_P256: nid = EVP_PKEY_EC; break;
    default: return NULL;
    }
...
void av_kex_free(av_kex *k) {
    if (!k) return;
    if (k->key) EVP_PKEY_free(k->key);
    free(k);
}

long av_kex_public(av_kex *k, unsigned char *out, size_t out_len) {
    if (!k) return -1;
    if (k->group == AV_KEX_X25519) {
        size_t n = out_len;
...
long av_kex_derive(av_kex *k, const unsigned char *peer, size_t peer_len,
                   unsigned char *out, size_t out_len) {
    if (!k) return -1;
    EVP_PKEY *pub = NULL;
...
#define AV_MAX_CHAIN 8

struct av_certkey {
    X509 *chain[AV_MAX_CHAIN];
    int count;
    EVP_PKEY *key;
};
...
av_certkey *av_certkey_load(const char *cert_path, const char *key_path,
                            char *err, size_t err_len) {
    ERR_clear_error();
    av_certkey *ck = calloc(1, sizeof(*ck));
    if (!ck) return NULL;
...
void av_certkey_free(av_certkey *ck) {
    if (!ck) return;
...
long av_certkey_cert_der(av_certkey *ck, int index,
                         unsigned char *out, size_t out_len) {
...
int av_certkey_schemes(av_certkey *ck, uint16_t *out, int max) {
    if (!ck || !ck->key || max <= 0) return 0;
    int n = 0;
    switch (EVP_PKEY_base_id(ck->key)) {
    case EVP_PKEY_RSA:
    case EVP_PKEY_RSA_PSS:
        if (n < max) out[n++] = AV_SIG_RSA_PSS_RSAE_SHA256;
        if (n < max) out[n++] = AV_SIG_RSA_PSS_RSAE_SHA384;
        if (n < max) out[n++] = AV_SIG_RSA_PSS_RSAE_SHA512;
        break;
    case EVP_PKEY_EC:
        /* The curve fixes the digest, so a P-256 key can only ever produce
         * ecdsa_secp256r1_sha256. */
        if (EVP_PKEY_bits(ck->key) >= 384) {
            if (n < max) out[n++] = AV_SIG_ECDSA_SECP384R1_SHA384;
        } else {
            if (n < max) out[n++] = AV_SIG_ECDSA_SECP256R1_SHA256;
        }
        break;
    case EVP_PKEY_ED25519:
        if (n < max) out[n++] = AV_SIG_ED25519;
        break;
    default:
        break;
    }
...
long av_certkey_sign(av_certkey *ck, uint16_t scheme,
    ...
    int pss = 0;
    switch (scheme) {
    case AV_SIG_RSA_PSS_RSAE_SHA256: md = EVP_sha256(); pss = 1; break;
    case AV_SIG_RSA_PSS_RSAE_SHA384: md = EVP_sha384(); pss = 1; break;
    case AV_SIG_RSA_PSS_RSAE_SHA512: md = EVP_sha512(); pss = 1; break;
    case AV_SIG_ECDSA_SECP256R1_SHA256: md = EVP_sha256(); break;
    case AV_SIG_ECDSA_SECP384R1_SHA384: md = EVP_sha384(); break;
    case AV_SIG_ED25519: md = NULL; break;
    default: return -1;
    }
