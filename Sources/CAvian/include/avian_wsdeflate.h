 ...
 */
#ifndef AVIAN_WSDEFLATE_H
#define AVIAN_WSDEFLATE_H
...
int av_ws_deflate_reset(void *z);
int av_ws_inflate_reset(void *z);
...
int av_ws_deflate_run(void *z, const uint8_t *in, size_t n,
...
int av_ws_inflate_run(void *z, const uint8_t *in, size_t n,
                      uint8_t *out, size_t cap, size_t *consumed, size_t *produced);
