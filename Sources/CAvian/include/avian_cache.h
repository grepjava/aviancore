 ...
 * ------------------------------------------------------------------------- */
#ifndef AVIAN_CACHE_H
#define AVIAN_CACHE_H
...
int av_cache_enabled(void);
uint32_t av_cache_max_head(void);
uint32_t av_cache_max_body(void);
...
/* Stores the response to the request numbered `sequence` (av_cache_begin),
